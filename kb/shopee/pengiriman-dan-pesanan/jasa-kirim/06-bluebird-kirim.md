---
id: shp-pengiriman-006
title: Bluebird Kirim
platform: shopee
...
Berikut *detail* ketentuan menggunakan jasa kirim Bluebird Kirim:
...
⚠️ **Catatan**
  ...
  - Pastikan Anda telah[ mengaktifkan jasa kirim Bluebird Kirim](https://seller.shopee.co.id/edu/article/12518/Mengatur-Jasa-Kirim) pada pengaturan toko dan setiap produk agar Pembeli dapat memilih jasa kirim Bluebird Kirim.
...
**Area Jangkauan Penjual Bluebird Kirim**

⚠️ **Catatan**

  - Jika kurir menanyakan dua angka kode pengiriman, Anda dapat menyarankan untuk menghubungi *call center* Bluebird melalui aplikasi *driver*/kurir.
  - Jika Anda tidak bisa memilih jasa kirim Bluebird Kirim, area Anda mungkin belum masuk jangkauan layanan jasa kirim Bluebird Kirim atau melebihi 80km.

  

**Produk yang Tidak Diperbolehkan Dikirim dengan Bluebird Kirim**

Berikut merupakan produk-produk yang tidak diperbolehkan dikirim dengan jasa kirim Bluebird Kirim:

  - Alkohol/Minuman Keras
  - Senjata api/tajam
  - Material perjudian/Pornografi
  - Uang asli dan uang palsu/Surat berharga
  - Bahan Peledak
  - Bahan Kimia
  - Bahan Radioaktif
  - Obat-obatan terlarang
  - Bahan/barang berbahaya
  - Makanan cepat basi/rusak
...
⚠️ **Catatan**
  ...
  - Shopee berhak sewaktu-waktu mengubah atau menambahkan daftar produk yang tidak diperbolehkan dikirim sesuai kebijakan dari Bluebird Kirim.

  

**Kendala Seputar Jasa Kirim Bluebird Kirim**
